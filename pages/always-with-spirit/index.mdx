...
<div className="book-description always-with-spirit">

<h2 className="book-title">Always With Spirit</h2>
<h3 className="book-subtitle">A Leinfelder legacy</h3>

This ancestral history begins with a survivor of
...
<p>
  <span className="lead-in">
    The <a href="/always-with-spirit/names">index</a> contains over 1500 names
  </span>{" "}
  covering 19 generations of Leinfelder descendants. If your name or the birth
  name of your biological parent or grandparent is included in this end list,
  you are related to all of those individuals.
</p>
